...
function buttonCreator($atts, $content = null){
...
function buttonsCreator($atts, $content = null){
  return '<div class=buttons>' . do_shortcode($content) . '</div>';
}


function cardCreator($atts, $content = null){
    extract(shortcode_atts(array(
    'url' => '',
  ), $atts));
    return '<div class=card-container><div class=lower-layer><img src=' . $url . '></div><div class=higher-layer>' . do_shortcode($content) . '</div></div>';
}
...
add_shortcode('card', 'cardCreator');
add_shortcode('buttons', 'buttonsCreator');
add_shortcode('button', 'buttonCreator');
